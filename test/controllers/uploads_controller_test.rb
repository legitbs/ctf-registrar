...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { challenge_id: @upload.challenge_id, file: @upload.file, user_id: @upload.user_id } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { challenge_id: @upload.challenge_id, file: @upload.file, user_id: @upload.user_id } }
